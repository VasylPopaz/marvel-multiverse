    ...
    <>
      ...
      >
        <div className="container relative lg:flex lg:gap-[134px]">
          <div className="mb-10 md:mb-8 lg:mb-0 lg:w-[538px]">
            <p className="mb-3.5 uppercase leading-[1.29] text-[#ffffffb2] md:mb-4 md:text-[18px] md:leading-[1.6]">
              Web-based platform
            </p>
            <h1 className="mb-4 text-[44px] font-medium leading-[1] tracking-[-0.02em] md:text-[80px] lg:mb-[18px]">
      ...
      {characters?.length ? (
        <section id="random-characters" className="pb-[80px] md:pb-[128px]">
          <div className="container">
            <h2 className="mb-11 text-[28px] font-medium uppercase leading-[1.14] md:text-[44px] md:leading-[1]">
              Random characters
            </h2>
